...
growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly",
    ...
    price: "4.99", sku: "GROHACK2", details: "Charge you monthly for unlimited access to mentor team.", 
    download_url: "https://s3.amazonaws.com/erickuhnonemonthstripe/money-is-in-the-back-end-whitepaper_sbagrp.pdf",
...
copywriting_monthly = Product.create(title: "Copywriting Monthly",
    subtitle: "Ongoing Course", author: "Mattan Griffel", 
    length: "6 Months", author_image_name: "teacher-image.jpg",
    price: "4.99", sku: "COPYWRITE2", details: "Charge you monthly for unlimited access to mentor team.", 
    download_url: "https://s3.amazonaws.com/erickuhnonemonthstripe/money-is-in-the-back-end-whitepaper_sbagrp.pdf",
    description: %{<p>A copy writer is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
...
analytics_monthly = Product.create(title: "Analytics Monthly",
    subtitle: "Ongoing Course", author: "Mattan Griffel", 
    length: "6 Months", author_image_name: "teacher-image.jpg",
    price: "4.99", sku: "ANALYTICS2", details: "Charge you monthly for unlimited access to mentor team.", 
    download_url: "https://s3.amazonaws.com/erickuhnonemonthstripe/money-is-in-the-back-end-whitepaper_sbagrp.pdf",
    description: %{<p>A copy writer is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
